...
ALLOWED_HOSTS = ['52.212.87.244', '127.0.0.1', '34.245.178.93', '18.228.172.18']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dbmaster',
        'USER': 'dbmasteruser',
        'PASSWORD': 'BO&OE$eZtfOk:;jpplNyj]x1As9=&gk?',
        'HOST': 'ls-4568c56a5a65d2d7ab38d79a15b648e49bd6edb1.clzycusc5rcf.eu-west-1.rds.amazonaws.com',
        'PORT': '5432',
    }
