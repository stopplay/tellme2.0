...
class ContractModelFormWithSponte(forms.ModelForm):
	...
	class Meta:
		model = Contract
		fields = ['chain', 'date', 'end_date', 'pdf', 'terms_of_contract', 'terms_of_contract_2', 'contract_free_class_id_sponte', 'situation_id_sponte', 'situation_sponte', 'student_name_sponte', 'student_id_sponte', 'course_id_sponte', 'class_id_sponte', 'class_name_sponte', 'course_name_sponte', 'contract_type_id', 'initial_date_sponte', 'end_date_sponte', 'date_of_registration_sponte', 'type_of_registration_sponte', 'contractor_sponte', 'name_of_curricular_matrix_sponte', 'financial_launched_sponte', 'contract_number_sponte', 'closing_date_sponte']
		widgets = {
			'date': forms.DateInput(attrs={'type':'date', 'class':'labelandform', 'required':True, 'style':"width:120%"}),
			'end_date': forms.DateInput(attrs={'type':'date', 'class':'labelandform', 'required':True, 'style':"width:120%"}),
...
class ContractModelFormWithoutSponte(forms.ModelForm):
	...
	class Meta:
		model = Contract
		fields = ['chain', 'date', 'end_date', 'pdf', 'terms_of_contract', 'terms_of_contract_2']
		widgets = {
			'date': forms.DateInput(attrs={'type':'date', 'class':'form-control', 'required':True, 'style' : "width: 100%" }),
			'end_date': forms.DateInput(attrs={'type':'date', 'class':'labelandform', 'required':True, 'style':"width:100%"}),
