...
class Contract(models.Model):
    ...
    first_witness_signed = models.BooleanField(default=False)
    second_witness_signed = models.BooleanField(default=False)
    student_auth_signed = models.BooleanField(default=False)
    counter_signed = models.BooleanField(default=False)
    all_witness_signed = models.BooleanField(default=False)
    all_signed = models.BooleanField(default=False)
    pdf = models.FileField(null=True, blank=True, verbose_name = 'Contrato (PDF apenas e tamanho máximo de 2MB)')
    terms_of_contract = models.FileField(null=True, blank=True, verbose_name = 'Termos Aditivos do Contrato (1) (PDF apenas e tamanho máximo de 2MB)')
    terms_of_contract_2 = models.FileField(null=True, blank=True, verbose_name = 'Termos Aditivos do Contrato (2) (PDF apenas e tamanho máximo de 2MB)')
    ...
    third_auth_signe = models.ForeignKey(Parent, on_delete=models.SET_NULL, null=True, blank=True, related_name='third_responsible', default=None)
    first_witness_signe = models.ForeignKey(Witness, on_delete=models.SET_NULL, null=True, blank=True, related_name='first_witness', default=None)
    second_witness_signe = models.ForeignKey(Witness, on_delete=models.SET_NULL, null=True, blank=True, related_name='second_witness', default=None)
    ...
    third_auth_signed_timestamp = models.DateTimeField(null=True, blank=True)
    student_auth_signed_timestamp = models.DateTimeField(null=True, blank=True)
    first_witness_signed_timestamp = models.DateTimeField(null=True, blank=True)
    second_witness_signed_timestamp = models.DateTimeField(null=True, blank=True)
    ...
    third_auth_hash = models.CharField(max_length=255, null=True, blank=True)
    first_witness_hash = models.CharField(max_length=255, null=True, blank=True)
    second_witness_hash = models.CharField(max_length=255, null=True, blank=True)
