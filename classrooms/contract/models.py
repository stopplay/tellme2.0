...
class Contract(models.Model):
	...
	student_auth_signed = models.BooleanField(default=False)
	...
	terms_of_contract = models.FileField(null=True, blank=True, verbose_name = 'Termos Aditivos do Contrato (1)')
	terms_of_contract_2 = models.FileField(null=True, blank=True, verbose_name = 'Termos Aditivos do Contrato (2)')
	...
	student_auth_signe = models.ForeignKey(Student, on_delete=models.SET_NULL, null=True, blank=True, related_name='student_responsible', default=None)
	...
	student_auth_signed_timestamp = models.DateTimeField(null=True, blank=True)
	...
	student_auth_hash = models.CharField(max_length=255, null=True, blank=True)
