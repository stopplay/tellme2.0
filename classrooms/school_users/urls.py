...
urlpatterns = [
    ...
    path('select_parent/<int:student_id>/<type_of_user>', views.select_parent, name='select_parent'),
    path('confirm_parent/<int:student_id>/<int:parent_id>/<type_of_user>', views.confirm_parent, name='confirm_parent'),
    ...
    url('update_perfil', views.update_profile, name='update_perfil'),
