                                    ...
                                    if column[4]==column[5]:
                                        if column[6]:
                                            ...
                                            if User.objects.filter(username=school_to_add.school_name+'-parent-'+column[0]).count()<1:
                                                ...
                                                _, created = Parent.objects.get(profile = User.objects.get(username=school_to_add.school_name+'-parent-'+column[0])).update(name = column[1]+' '+column[2], tell_me_user_id=column[7])
